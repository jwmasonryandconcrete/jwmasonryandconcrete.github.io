...
<div class="w3-row-padding">
  ...
  <div class="w3-third l4 m8 w3-margin-bottom">
    <div class="w3-display-container">
      ...
      <img src="poop.jpg" alt="House" style="width:85%">
    </div>
  </div>
  <div class="w3-third l4 m8 w3-margin-bottom">
    <div class="w3-display-container">
      <div class="w3-display-topleft w3-black w3-padding">Stonework</div>
      <img src="stonework2.jpg" alt="House" style="width:85%">
    </div>
  </div>
</div>
-->
...
<!-- <a href="tel:401-444-4444" class="w3-bar-item w3-text-black-button"><b></b><i class="material-icons" style="font-size:24px;color:black;">phone</i> 401-444-4444</span> -->